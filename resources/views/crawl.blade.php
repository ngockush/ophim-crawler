...
$defaultBreadcrumbs = [
    ...
    'Crawler' => backpack_url('plugin/ngockush-crawler'),
];
...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <textarea class="form-control" rows="5" name="link">https://anime.s2fastplayer.xyz/movies/phim-moi-cap-nhat?api_key=QuaWpJdasPfXSlRdqjltMzAlMkYwMSUyRjIwMjM=</textarea>
    ...
    <script>
        ...
        const processMovie = async (slug) => {
            ...
            const response = await fetch("{{ backpack_url('plugin/ngockush-crawler/crawl') }}", {
                method: 'POST',
                headers: {
        ...
        $("#movies-get-handle").click(async function() {
            ...
            const response = await fetch("{{ backpack_url('plugin/ngockush-crawler/get-movies') }}", {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
